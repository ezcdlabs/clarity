...
func TestRenderPlain_EmptySnapshot_ShowsHeaderAndSections(t *testing.T) {
	out := plain.RenderSnapshot("clarity", view(core.Snapshot{}), time.Unix(0, 0), plain.Options{})
...
func TestRenderPlain_HeaderShowsCIAndDeployBadges(t *testing.T) {
	...
	out := plain.RenderSnapshot("clarity", view(snap), time.Unix(300, 0), plain.Options{})
...
func TestRenderPlain_PassedCommit_ShowsTickAndAuthor(t *testing.T) {
	...
	out := plain.RenderSnapshot("clarity", view(snap), time.Unix(200, 0), plain.Options{})
...
func TestRenderPlain_ShowSHAs_OptIn(t *testing.T) {
	...
	defaultOut := plain.RenderSnapshot("clarity", view(snap), time.Unix(200, 0), plain.Options{})
	if strings.Contains(defaultOut, short) {
		t.Errorf("default output should not contain short SHA, got:\n%s", defaultOut)
	}

	withSHAs := plain.RenderSnapshot("clarity", view(snap), time.Unix(200, 0), plain.Options{ShowSHAs: true})
...
func TestRenderPlain_Limit_TruncatesCommits(t *testing.T) {
	...
	out := plain.RenderSnapshot("clarity", view(snap), time.Unix(200, 0), plain.Options{Limit: 1})
...
func TestRenderPlain_WeekDivider_AppearsAboveFirstBatchOfWeek(t *testing.T) {
	...
	out := plain.RenderSnapshot("clarity", view(snap), d.Add(time.Hour), plain.Options{})
...
func TestRenderPlain_WeekDivider_TwoWeeks_TwoDividers(t *testing.T) {
	...
	out := plain.RenderSnapshot("clarity", view(snap), d2.Add(time.Hour), plain.Options{})
